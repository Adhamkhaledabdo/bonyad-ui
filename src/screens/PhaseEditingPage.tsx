      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.infoCard}>
          ...
          <Text style={[styles.infoText, { color: colors.text }]}>
            {project.status?.toUpperCase() === 'APPROVED' 
              ? t('You can now plan and edit phases for this project.')
              : t('You can edit phases and view user feedback.')}
          </Text>
        </View>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            console.log('🟡 [PhaseEditingPage] Opening phase editing modal');
